...
export default function ProfilePage() {
  ...
  return (
    <main className="mx-auto flex min-h-full w-full max-w-4xl flex-col gap-6 overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
      <div className="rounded-4xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/40">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-slate-500">Review birth details and update your username or passcode.</p>
        </div>

        <div className="grid gap-6 md:grid-cols-2">
          {readOnlyFields.map((field) => (
            <div key={field.label} className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
